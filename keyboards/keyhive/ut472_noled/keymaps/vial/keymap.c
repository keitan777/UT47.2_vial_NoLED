...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    _______, _______, _______, KC_CAPS, _______, KC_TRNS, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END
  ),
  ...
  [2] = LAYOUT(
    ...
    _______, _______, _______, KC_CAPS, _______, KC_TRNS, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
  ),
  ...
  [3] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, KC_TRNS, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R
  )
};
